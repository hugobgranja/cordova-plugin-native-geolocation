...
# cordova-plugin-native-geolocation

This plugin is based on [cordova-plugin-geolocation](https://github.com/apache/cordova-plugin-geolocation)
and its aim is to provide an android native implementation
using the [Google Play services location APIs](https://developer.android.com/training/location/)
...
This requires cordova 5.0+ ( current stable 1.0.0 )
    ...
    cordova plugin add cordova-plugin-native-geolocation
